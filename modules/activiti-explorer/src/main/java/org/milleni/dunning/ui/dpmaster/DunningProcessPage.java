 ...
 * @author Joram Barrez
 */
public class DunningProcessPage extends AbstractPage {
  ...
  DunningProcessListDetailPanel detailPanel;
  ...
  public void setDetailComponent(LazyLoadingQuery lazyLoadingQuery){
		 this.detailPanel =  new DunningProcessListDetailPanel(lazyLoadingQuery);
  ...
  public Component getSearchComponent() {
    ...
    return new DunningProcessSearchPanel(this);
  }
...
public DunningProcessListDetailPanel getDetailPanel(){
	return detailPanel;
}
