...
public class BulkProcessAdministration extends DetailPanel {
	...
	public BulkProcessAdministration() {
	...
	protected void initMembersTable() {
		managementService.createJobQuery().processDefinitionId(processDefinitionid)
