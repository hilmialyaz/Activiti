 ...
 */
public class CustomCompletedInstancesPanel extends DetailPanel {
  ...
  protected HistoricProcessInstance processInstance;
  protected ProcessDefinition processDefinition;
  
  public CustomCompletedInstancesPanel(String processInstaceId) {
