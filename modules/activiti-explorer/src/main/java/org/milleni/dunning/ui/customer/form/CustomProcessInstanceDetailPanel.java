 ...
 */
public class CustomProcessInstanceDetailPanel extends DetailPanel {

  private static final long serialVersionUID = 1L;
  
  protected static final Logger LOGGER = LoggerFactory.getLogger(CustomProcessInstanceDetailPanel.class);
  ...
  public CustomProcessInstanceDetailPanel(String processInstanceId) {
    ...
    if(processInstance==null){
    	this.processDefinition = getProcessDefinition(historicProcessInstance.getProcessDefinitionId());
    }else{
