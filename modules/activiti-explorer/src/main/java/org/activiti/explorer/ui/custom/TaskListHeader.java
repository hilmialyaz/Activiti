...
public class TaskListHeader extends Panel {
	...
	protected VerticalLayout verlayout = null;

	protected HorizontalLayout layout;
	protected HorizontalLayout inLayout;
		...
		addActionHandler(new Handler() {
			public void handleAction(Action action, Object sender, Object target) {
				if (inputField.getValue() != null && !"".equals(inputField.getValue().toString())) {
					ExplorerApp.get().getViewManager().showCustomTaskSearchPage(inputField.getValue().toString());
				}
			}
