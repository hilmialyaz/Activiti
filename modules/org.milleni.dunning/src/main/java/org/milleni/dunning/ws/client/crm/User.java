...
@XmlType(name = "User", namespace = "http://milleni.com/Crm", propOrder = {
    "confirmPassword",
    "email",
    "fullName",
    "id",
...
public class User {
    ...
    @XmlElementRef(name = "ConfirmPassword", namespace = "http://milleni.com/Crm", type = JAXBElement.class)
    ...
    public void setConfirmPassword(JAXBElement<String> value) {
        this.confirmPassword = ((JAXBElement<String> ) value);
    }
