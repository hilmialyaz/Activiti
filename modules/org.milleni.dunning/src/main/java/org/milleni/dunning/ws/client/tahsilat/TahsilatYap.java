 ...
 *         &lt;element name="tahsilatKalemleri" type="{http://milleni.com/online_tahsilat}ArrayOfTahsilatKalemiExt" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "TahsilatYap")
public class TahsilatYap {

    protected GuvenlikBilgisi guvenlikBilgisi;
    protected ArrayOfTahsilatKalemiExt tahsilatKalemleri;
     ...
     * @return
     *     possible object is
     *     {@link ArrayOfTahsilatKalemiExt }
     *     
     */
    public ArrayOfTahsilatKalemiExt getTahsilatKalemleri() {
     ...
     *     
     */
    public void setTahsilatKalemleri(ArrayOfTahsilatKalemiExt value) {
